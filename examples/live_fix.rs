...
fn main() {
    ...
    // are fresher than any daily download and need no network)
    let mut n_self = 0;
    ...
    // subframes decoded live). Falls back to the coarse snapshot below when
    // fewer than 4 channels are anchored.
